...
The pinned upstream base commit used during validation is recorded in `patches/go2rtc-cam2-upstream-commit.txt`.

go2rtc is distributed under the MIT License. Copyright (c) 2022 Alexey Khit and contributors. Refer to the upstream repository for the complete license text and current licensing information.
